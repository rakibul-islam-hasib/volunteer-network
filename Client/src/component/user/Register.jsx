        ...
        <>
            ...
            <div className='min-h-[80vh] flex items-center'>
                ...
                <div className="w-1/3 mx-auto">
                    <div className="border rounded-md bg-white p-6 border-violet-600">
                        <p className="text-2xl font-bold">Login to Continue</p>
                        <p className="">It will take less than 1 minutes</p>
